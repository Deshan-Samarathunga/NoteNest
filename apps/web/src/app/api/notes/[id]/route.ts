...
export async function GET(request: NextRequest, context: RouteContext) {
  ...
  try {
    const note = await getNoteStorage(auth).readActiveNote(await getId(context), getPassphrase(request));
...
export async function PUT(request: NextRequest, context: RouteContext) {
  ...
  try {
    ...
    await getNoteStorage(auth).syncPush([parsed.data as NotePayload], getPassphrase(request));
...
export async function DELETE(request: NextRequest, context: RouteContext) {
  ...
  try {
    ...
    await getNoteStorage(auth).syncPush([note], getPassphrase(request));
